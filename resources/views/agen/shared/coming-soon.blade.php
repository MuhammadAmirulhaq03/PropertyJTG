        ...
        <div class="bg-white shadow-sm rounded-3xl border border-[#FFE7D6] p-10 text-center space-y-6">
            ...
            <div class="space-y-2">
                ...
                <p class="text-gray-600">
                    {{ $message ?? __('We are polishing this workspace for agents. Hang tight!') }}
                </p>
            </div>

            <div>
                <a href="{{ route('agent.dashboard') }}" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#DB4437] text-white text-sm font-semibold hover:bg-[#c63c31] transition">
